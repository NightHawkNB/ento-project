        ...
        <main class="dashboard-main">
            ...
            <section class="dis-flex-col al-it-ba wid-100 pad-10 gap-10">
                ...
                <script>
                    ...
                    const lastMonth = new Date(today.getFullYear(), today.getMonth() - 1, 1).toLocaleDateString(undefined, {
                        month: 'long'
                    });
                    const twoMonthsAgo = new Date(today.getFullYear(), today.getMonth() - 2, 1).toLocaleDateString(undefined, {
                        month: 'long'
                    });
                    const threeMonthsAgo = new Date(today.getFullYear(), today.getMonth() - 3, 1).toLocaleDateString(undefined, {
                        month: 'long'
                    });
                    ...
                    const data = {
                        ...
                        datasets: [{
                            label: ['new'],
                            data: [<?= $venuevreqs[0]->venuevreqs ?>, <?= $uservreqs[0]->uservreqs ?>],
