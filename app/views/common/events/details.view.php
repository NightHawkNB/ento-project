                ...
                <div class="bg-white pad-20">
                    ...
                    <ul type="none" class="mar-0 dis-flex-col gap-10">
                        ...
                        <li>02. Please note that our online tickets cannot be changed once purchased. This includes
                            ...
                            ensure that you have chosen the correct ticket.
                        </li>
                        <li>02. අන්තර්ජාල ප්‍රවේශපත්‍රයක් කිසිදු අයුරකින් හෝ කිසිදු හේතුවක් මත වෙනස් කිරීමකට ( ඛාණ්ඩය /
                            ප්‍රසංගය / ආසන හෝ ආසනය / මිළ ආදී කිසිවක්... ) හැකියාවක් නොමැති අතර කිසිදු අයුරකින් නැවත
                            ගෙවීමක් අප විසින් සිදු කරනු නොලැබේ. එම නිසා ඔබගේ අන්තර්ජාල ප්‍රවේශ පත්‍රය නිවැරදි ලෙස තෝරා
                            ලබාගන්න.
                        </li>
                    </ul>
                    </p>
                    ...
                    <?php if (!empty($event->custom_venue)): ?>
                        <a href="#venue_01">
                            <div class="card-profile bg-black-2 pad-10 bor-rad-5 dis-flex-col al-it-ce">
                                ...
                                <img src="<?= ROOT ?>/assets/images/venues/general.png" alt="venue_01"
                                     class="venue-image">
