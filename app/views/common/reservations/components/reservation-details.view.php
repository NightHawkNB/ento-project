...
<div class="main-wrapper">
    ...
    <main class="dashboard-main">
        ...
        <section class="wid-100 al-it-ce pad-10 dis-flex-col gap-20">
            ...
            <h1 class="mar-10-0 txt-c-black txt-w-bold" style="font-size: 1.5rem">Reservation Details</h1>

            <div class="bg-white-90 bor-rad-5 wid-80 pad-30-10 dis-flex-col gap-20">

                <?php
                extract((array)$reservation);
                ?>
            ...
            <div class="bg-white-90 bor-rad-5 wid-80 pad-10 dis-flex ju-co-ce gap-20 flex-wrap">
<!---->
<!--                <a href="--><?php //= ROOT.'/chat/reserve/'.Auth::getUser_id().'/'.$client_id.'/'.$reservation_id ?><!--" class="action-btn">-->
