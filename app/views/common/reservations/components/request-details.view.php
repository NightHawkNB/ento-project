...
<div class="main-wrapper">
    ...
    <main class="dashboard-main">
        ...
        <section class="wid-100 al-it-ce pad-10 dis-flex-col gap-20">
            ...
            <div class="bg-white-90 bor-rad-5 wid-80 pad-10 dis-flex ju-co-ce gap-20 sh flex-wrap action-btn">

                <a href="<?= ROOT.'/chat/resreq/'.Auth::getUser_id().'/'.$client_id.'/'.$req_id ?>" class="action-btn">
