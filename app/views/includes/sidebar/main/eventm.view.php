...
<li class="nav-item <?= set_activated($_SESSION['USER_DATA']->user_type.'/view_events') ?>">
    <a class="nav-link" href="<?= ROOT ?>/<?= strtolower($_SESSION['USER_DATA']->user_type) ?>/view_events">
