...
<header class="cols-12 dis-flex pad-20 al-it-ce bg-black-2 flex-wrap gap-10 ju-co-ce">
    ...
    <div class="dis-flex gap-20 al-it-ce txt-c-white">
        ...
        <?php else: ?>
            ...
            <div class="dis-flex gap-10 al-it-ce bg-primary bor-rad-5" style="padding: 2px 5px">
                <img src="<?= $_SESSION['USER_DATA']->image ?>" alt="profile-image" style="width: 35px; border-radius: 50%">
                Hi, <?= ucfirst(Auth::getFname())." ".substr(ucfirst(Auth::getLname()), 0, 1) ?>
            </div>
