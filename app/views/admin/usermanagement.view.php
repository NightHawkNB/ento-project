...
<body>
    <div class="main-wrapper">
        ...
        <main class="dashboard-main">
            ...
            <div class="bg-black-1 mar-10 wid-100 dis-flex-col pad-20 gap-20 bor-rad-5 ju-co-ce al-it-st user-mng">
            
                <div class="dis-flex ju-co-ce gap-20">
                    <a href="<?= ROOT ?>/admin/usermng/admin">
                ...
                <div class="dis-flex ju-co-ce gap-20">
                    <a href="<?= ROOT ?>/admin/usermng/singer">
                        <button class="btn-lay-2 push-right hover-pointer "  style="font-size:30px; background-color:purple; text-align:center; border: none" >
                    ...
                    <a href="<?= ROOT ?>/admin/usermng/client">
                        <button class="btn-lay-2 push-right hover-pointer "  style="font-size:30px; background-color:purple; text-align:center; border: none" >
