    ...
    <div class="u bg-white txt-c-black dis-flex gap-10  pad-10 bor-rad-5 al-it-ce" data-title="<?= $fname . $lname ?>" data-category="<?=$user_type?>">
        ...
        <div class="dis-flex gap-10" style="margin-left:auto">
            ...
            <a href="<?= ROOT ?>/admin/usermng/disable-user/<?= $user_id ?>">
                <button class="btn-lay-2 push-right hover-pointer "  style="background-color:#7b51d3; text-align:center; border: none" >
                    <?php if($disabled) echo 'E'; else echo 'D'; ?>
                </button>
            </a>
        </div>
    </div>
